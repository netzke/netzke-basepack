...
module Netzke
  ...
  # * pagination
  # * filtering
  # * dynamic properties and column configuration
  #
  # == Class configuration
  ...
  # 
  #     Netzke::GridPanel.config[:column_filters_available] = false
  #     Netzke::GridPanel.config[:default_config][:ext_config][:enable_config_tool] = false
  # 
  # The following configuration options are available:
  # * :column_filters_available - (default is true) generate javascript code for filters available from the column 
  # context menu
  # * :config_tool_available - (default is true) generate javascript code for configuration tool 
  # that launches the configuration panel
  # * :default_config - a hash of default configuration options for each instance of the GridPanel widget.
  #  See the "Instance configuration" seccion below.
  # 
  # == Instance configuration
  # TODO: describe all the possible ways that a widget can be configured
  # 
  ...
  #     ["user_id_not", user_id]
  # 
  # * :ext_config - a hash of configuration options that get passed straight to the contstructor of the client-side
  # (javascript) of the widget. Hence, any options understood by the underlying Ext.grid.GridPanel are accepted here.
  # Additionaly, the following options are introduced by Netzke::GridPanel:
  #   * :enable_column_filters - enable filters in column context menu
  #   * :load_inline_data - load initial data into the grid right after its instantiation (saves a request 
  # to the server)
  #   * :bbar - array of Ext actions that will be displayed as buttons in the bottom bar 
  #
  class GridPanel < Base
    include Netzke::GridPanelJs  # javascript (client-side)
    include Netzke::GridPanelApi # API (server-side)
    ...
    api :get_data, :post_data, :delete_data, :resize_column, :move_column, :hide_column, :get_combobox_options
    ...
    def default_columns
      ...
      exposed_columns = normalize_columns(data_class.netzke_exposed_attributes)
