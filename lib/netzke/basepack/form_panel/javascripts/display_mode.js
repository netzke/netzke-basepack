Ext.override(Ext.form.Field, {
  ...
  setDisplayMode: function(onOff){
    ...
    owner.insert(idx, this.displayModeConfig(onOff));
  ...
  displayModeConfig: function(onOff){
    return Ext.apply(this.initialConfig, onOff ? {xtype: 'displayfield', origXtype: this.xtype, value: this.value} : {xtype: this.origXtype, value: this.value});
  }
