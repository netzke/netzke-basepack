= v0.5.10 - EDGE
* Impr: Checkbox replaced with tristate checkbox in multi-edit form in GridPanel.
...
* Impr: Grid forms are now getting the same fields as specified for the grid.
