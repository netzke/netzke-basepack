{
  ...
  initComponent: function(){
    ...
    Ext.each(this.columns, function(column){
      ...
      // 'type' is used to specify the correct filter type by the filters feature
      if (column.filterable) extraConfig.type = this.filterTypeForAttrType(column.attrType);
    ...
    this.store.totalCount = this.inlineData[this.store.getProxy().getReader().totalProperty],
  ...
  onAddInline: function(){
    ...
    var r = Ext.ModelManager.create({}, this.id), // Note: default values are taken from the model's field's defaultValue property
