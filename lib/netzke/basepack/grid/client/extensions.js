 ...
 */
Ext.define('Netzke.Basepack.Grid.ArrayReader', {
...
Ext.define('Netzke.Basepack.Grid.Proxy', {
  ...
  // NOTE: not used, as serverDelete is being called directly from the grid
