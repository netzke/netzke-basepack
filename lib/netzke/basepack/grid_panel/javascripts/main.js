      ...
      if (c.editor && c.editor.xtype == 'checkbox') {
        ...
        if (!c.renderer) {
          ...
          c.renderer = function(value){
            if (c.assoc) {
              return this.associationValues[c.name][value] || value;
            } else if (this.editor && this.editor.getStore && this.editor.getStore().getTotalCount() > 0) {
              return this.editor.getStore().getAt(value-1).get('name');
            } else {
              return value;
            }
          };
