...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<netzke-core>, [">= 0", "= 0.1.0"])
      s.add_runtime_dependency(%q<skozlov-netzke-core>, [">= 0", "= 0.1.0"])
    else
      s.add_dependency(%q<searchlogic>, [">= 1.6.2"])
      s.add_dependency(%q<netzke-core>, [">= 0", "= 0.1.0"])
      s.add_dependency(%q<skozlov-netzke-core>, [">= 0", "= 0.1.0"])
    end
  else
    s.add_dependency(%q<searchlogic>, [">= 1.6.2"])
    s.add_dependency(%q<netzke-core>, [">= 0", "= 0.1.0"])
