# require "netzke/widget/grid_panel/grid_panel_js"
# require "netzke/widget/grid_panel/grid_panel_api"
# require "netzke/widget/grid_panel/grid_panel_columns"
  ...
  module Widget
    ...
    class GridPanel < Base
      ...
      def default_config
        ...
        res[:bbar] = default_bbar
        res[:context_menu] = default_context_menu
      ...
      def actions
        ...
        actions = {                                     
          ...
          :apply        => {:text => 'Apply',        :disabled => config[:prohibit_update] && ext_config[:prohibit_create]},
