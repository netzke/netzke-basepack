{
  ...
  initComponent: function(){
    ...
    // Cell editing
    if (!this.prohibitUpdate && this.enableEditInline && !this.config.infiniteScrolling) {
    ...
    if (this.enableEditInForm && (!this.enableEditInline || this.config.infiniteScrolling)) {
  ...
  netzkeBuildStore: function(buffered) {
    var storeType = buffered ? 'Ext.data.BufferedStore' : 'Ext.data.Store';
    var store = Ext.create(storeType, Ext.apply({
      fields: this.fields,
